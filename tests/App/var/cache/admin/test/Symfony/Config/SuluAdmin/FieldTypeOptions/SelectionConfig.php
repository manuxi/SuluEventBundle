...
class SelectionConfig 
{
    ...
    public function __construct(array $config = [])
    {
        ...
        if (array_key_exists('view', $config)) {
            $this->_usedProperties['view'] = true;
            $this->view = new \Symfony\Config\SuluAdmin\FieldTypeOptions\SelectionConfig\ViewConfig($config['view']);
            unset($config['view']);
        }

        if (array_key_exists('types', $config)) {
            $this->_usedProperties['types'] = true;
            $this->types = new \Symfony\Config\SuluAdmin\FieldTypeOptions\SelectionConfig\TypesConfig($config['types']);
            unset($config['types']);
        }
