 ...
 */
class EventDimensionContentConfig 
{
    private $model;
    private $repository;
    ...
    /**
     * @default 'Manuxi\\SuluEventBundle\\Entity\\EventDimensionContent'
    ...
    /**
     * @default 'Manuxi\\SuluEventBundle\\Repository\\EventDimensionContentRepository'
     * @param ParamConfigurator|mixed $value
     * @return $this
     */
